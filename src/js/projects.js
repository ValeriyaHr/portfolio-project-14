document.addEventListener("DOMContentLoaded", () => {
    ...
    const projects = [
        {
            imgSrc1x: '.src/img/energy-1x.jpg',
            imgSrc2x: '.src/img/energy-2x.jpg',
            alt: 'energy projects',
        ...
        {
            imgSrc1x: '.src/img/fruitbox-1x.jpg',
            imgSrc2x: '.src/img/fruitbox-2x.jpg',
        ...
        {
            imgSrc1x: '.src/img/jewelry-1x.jpg',
            imgSrc2x: '.src/img/jewelry-2x.jpg',
            ...
            {
            imgSrc1x: '.src/img/mimino-1x.jpg',
            imgSrc2x: '.src/img/mimino-2x.jpg',
            alt: 'mimino projects',
            stack: 'React, JavaScript, Node JS, Git',
        ...
        {
            imgSrc1x: '.src/img/power-1x.jpg',
            imgSrc2x:'.src/img/power-2x.jpg',
            alt: 'power projects',
            stack: 'React, JavaScript, Node JS, Git',
        ...
        {
            imgSrc1x: '.src/img/starlight-1x.jpg',
            imgSrc2x: '.src/img/starlight-2x.jpg',
...
{
            imgSrc1x: '.src/img/vyshyvanka-1x.jpg',
            imgSrc2x: '.src/img/vyshyvanka-2x.jpg',
                ...
                <div class="projects-item-conteiner">
                    ...
                    <a href="${project.link}" class="projects-btn" target="_blank">VISIT
                        <svg class="projects-icon" width="24" height="24">
                            <use href=".src/img/icons.svg#icon-arrow-visit"></use>
                        </svg>
                    </a>
                </div>
            `;
